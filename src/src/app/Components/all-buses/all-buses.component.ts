...
export class AllBusesComponent {
  ...
  constructor(private operatorService:AdminJwtClientService,private tokenService: TokenServiceService , private adminService:AdminJwtClientService , private router:Router) { }
